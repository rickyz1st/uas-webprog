...
<html lang="en">
  ...
  <body id="home">
    <!-- navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-warning shadow-sm fs-3 fixed-top">
      <div class="container">
        <a class="navbar-brand fs-3" href="#">Ricki Saputra </a>
    ...
    <section class="jumbotron text-center">
      <img src="img/contoh.jpeg" alt="Ricki Saputra" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Ricki Saputra</h1>
    ...
    <footer class="bg-warning text-center fs-3 pb-5">
      <p>Created with <i class="bi bi-heart-fill text-danger"></i> by<a href="https://www.instagram.com/rickyz1st/" class="text-white fw-bold"> Ricki Saputra</a></p>
    </footer>
    <!-- akhir footer -->
